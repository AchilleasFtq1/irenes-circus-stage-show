...
const MemberEdit: React.FC = () => {
  ...
  useEffect(() => {
    const fetchMember = async () => {
      ...
      try {
        setIsLoading(true);
        const member = await bandMembersAPI.getById(id);
        ...
        console.error('Error fetching band member:', err);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await bandMembersAPI.update(id, {
        name,
        instrument,
        bio,
        image: imageUrl
      ...
      setError(err instanceof Error ? err.message : 'Failed to update band member');
    } finally {
    ...
    return (
      <div className="p-6">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold">Edit Band Member</h1>
        </div>
